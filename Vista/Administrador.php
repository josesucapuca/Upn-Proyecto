...
<html lang="es">
    ...
    <body class="">
        ...
        <div id="main" role="main">
            <iframe id="myframe" name="myframe"  style="display:block;height: 85vh;"  class="iframe_principal" scrolling="si"  width="100%" frameborder="0"  style="background-color: #002752" src="prueba.php"></iframe>
