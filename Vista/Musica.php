...
$obj = new MusicaDAO();
$var = $obj->ListarMusicaByPersona($_SESSION["id_Persona"]);
...
if ($_SESSION["Usuario"] !== null) {
    ...
    <html lang="es" style="background-image: url('../images/fondo-musica.png');">
        ...
        <body class="bod" style="height: 100%">
                        ...
                        <div class="row" style="height: 100%;justify-content: center;margin-top: 20px;">
                            ...
                            <div class="row" >
                                <div class="col-sm-12" style="display: flex;align-items: center;">
                                    <div class="form-group col-xs-6 col-sm-3 col-md-2 col-lg-2" style="color: white;"><h1 class="titMusic" style="font-weight: 600;font-size: 30px"><i class="fa fa-music"></i> Musica <i class="fa fa-music"></i></h1></div>
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-6"> 
                                                                <div>
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="height: auto">
                                                                        <h3 style="text-align: center;margin: 5px;font-size: 14px;">Descripción</h3> 
                                                                    ...
                                                                    <?php if ($data->id_Musicas_Anotadas !== null) { ?>
                                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align: center;color: #0081c2;font-size: 25px;align-items: center;">
                                                                            ...
                                                                            <div>
                                                                                <a onclick="CMGM(<?php echo utf8_encode($data->id_Musicas_Anotadas); ?>)" class="btn btn-labeled btn-danger"> <span class="btn-label"><i class="glyphicon glyphicon-thumbs-up"></i></span>Me Gusta (<?php echo utf8_encode($data->count) ?>)</a>
                                                                            </div>
                                                                        </div>
                                                                    <?php } else { ?>
                                                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="text-align: center;color: #0081c2;font-size: 25px;align-items: center;">
                                                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><h3 style="text-align: center;margin: 5px;font-size: 14px;font-family: ">Opción</h3></div><br>
                                                                            <div>
                                                                                <a onclick="MGM(<?php echo utf8_encode($data->id_Musica); ?>,<?php echo $_SESSION["id_Persona"]; ?>)" class="btn btn-labeled btn-success"> <span class="btn-label"><i class="glyphicon glyphicon-thumbs-up"></i></span>Me Gusta  (<?php echo $data->count ?>)</a>
                                                                            </div>
                                                                        </div>
                                                                    <?php } ?>
                                                                </div>
            ...
            <script src="../js/Musica/Musica.js"></script>
