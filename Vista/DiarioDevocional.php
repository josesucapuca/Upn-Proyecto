...
if ($_SESSION["Usuario"] !== null) {
    ?><!DOCTYPE html>
    <html lang="es" style="background-image: url('../images/fodomatutina4.jpg');">
        <head>
                    ...
                    <div id="content" style="margin-bottom: 0px;display: flow-root;height: 100%;">
                        ...
                        <div class="row" style="display: flex;justify-content: center;">
                            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4 abs-center" style="text-align: center;">
                                ...
                                <h1 class="page-title txt-color-blueDark" style="font-weight: 600"><i class="fa fa-book"></i> Mi Diario devocional</h1>
                            </div>
                        </div>
