...
$obj = new MusicaDAO();
$var = $obj->ListarMusicaPersonal($_SESSION["id_Persona"]);

if ($_SESSION["Usuario"] !== null) {
    ?><!DOCTYPE html>
    <html lang="es" style="background-image: url('../images/fondo-musica.png');">
        <head>
            <meta charset="UTF-8">
        ...
        <body class="bod" style="height: 100%">
            <div class="modal fade" id="ModalIngresarMusica" tabindex="-1" role="dialog" aria-labelledby="ModalIngresarMusicaLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content" style="background: #007f98;">

                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" style="color: white;">
                                        <h2 class="modal-title" id="myModalLabel" style="text-align: center;"><i class="fa fa-music "></i> Ingresar Musica <i class="fa fa-music "></i></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tags" style="color: white;"> Nombre Musica</label>
                                        <input type="text" class="form-control" id="NomMusica" placeholder="Ingresa Nombre" style="background: #00000054;color: white; border: 0px;" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tags" style="color: white;"> Descipción de Musica</label>
                                        <textarea class="form-control" id="Descripcion" placeholder="Ingresa Descripción"  style="background: #00000054;color: white; border: 0px;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tags" style="color: white;"> URL de Musica</label>
                                        <input type="text" class="form-control" id="UrlMusica" placeholder="https://"  style="background: #00000054;color: white; border: 0px;"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 10px;text-align: right">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-default" data-dismiss="modal" id="CancelarModMusica">
                                            Cancelar
                                        </button>
                                        <button type="button" class="btn btn-success" id="IngresarMusica">
                                            Ingresar Musica
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="ModalModificarMusica" tabindex="-1" role="dialog" aria-labelledby="ModalModificarMusicaLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content" style="background: #007f98;">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" style="color: white;">
                                        <h2 class="modal-title" id="myModalLabel" style="text-align: center;"><i class="fa fa-music "></i> Modificar Musica <i class="fa fa-music "></i></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tags" style="color: white;"> Nombre Musica</label>
                                        <input type="text" class="form-control" id="ModNomMusica" placeholder="Ingresa Nombre" style="background: #00000054;color: white; border: 0px;" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tags" style="color: white;"> Descipción de Musica</label>
                                        <textarea class="form-control" id="ModDescripcion" placeholder="Ingresa Descripción"  style="background: #00000054;color: white; border: 0px;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="tags" style="color: white;"> URL de Musica</label>
                                        <input type="text" class="form-control" id="ModUrlMusica" placeholder="https://"  style="background: #00000054;color: white; border: 0px;"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 10px;text-align: right">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-success" id="ModificarMusica">
                                            Modificar Musica
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="pull-right">
                            ...
                            <div id="" class="transparent pull-right">
                                <ul id="" class="header-dropdown-list ">
                                    ...
                                    <li class="volver" >
                                        <button id="volver" class="btn btn-labeled btn-primary" data-toggle="modal" data-target="#ModalIngresarMusica" style="font-size: 13px;text-align: center;align-items: center;"> 
                        ...
                        <div class="row" style="height: 100%;justify-content: center;margin-top: 20px;">
                            ...
                            <div class="row" >
                                <div class="col-sm-12" style="display: flex;align-items: center;">
                                    <div class="form-group col-xs-6 col-sm-3 col-md-2 col-lg-2" style="color: white;">
                                        <h1 class="titMusic" style="font-weight: 600;font-size: 30px">Mi Musica </h1></div>
                                    <div class="form-group col-xs-6 col-sm-9 col-md-10 col-lg-10">
                                        <div class="input-group input-group-lg">
                                            <div class="icon-addon addon-lg">
                                                ...
                                                <input type="text" placeholder="Ingresar Musica" class="form-control" id="cadena">
                                                <label for="Musica" class="glyphicon glyphicon-search" rel="tooltip" title="Musica"></label>
                                            </div>
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" type="button" id="BuscarMusica"><i class="glyphicon glyphicon-search"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="well padding-10" style="margin: 10px;background: #ffffffa8;">

                                        <div class="row">

                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="background: #00000040" id="Musica">
                                                <?php if (mysqli_num_rows($var) > 0) { ?>
                                                    <?php
                                                    $i = 0;
                                                    while ($data = $var->fetch_object()) {
                                                        ?>
                                                        <div class="row" style="border-top: solid 1px #9e9c9c;border-bottom: solid 1px #9e9c9c;padding-bottom: 5px;">
                                                            <div id="tithim" class="col-xs-12 col-md-3 col-md-3 col-lg-2" style="display: flex;align-items: center;min-height: 60px;">
                                                                <div><strong  style="font-size:16px"> <?php echo utf8_encode($data->No_Musica); ?></strong></div>
                                                            </div>
                                                            <div class="col-xs-12 col-md-5 col-md-5 col-lg-6"  style="justify-content: center;display: flex;"> 
                                                                <div>
                                                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="height: auto">
                                                                        <h3 style="text-align: center;margin: 5px;font-size: 14px;font-weight: 900;">Descripción</h3> 
                                                                        <div style="text-align: center"><?php echo utf8_encode($data->Des_Musica) ?></div>
                                                                        <div style="text-align: center"> Por <strong><?php echo utf8_encode($data->persona) ?></strong></div>
                                                                    </div>

                                                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="justify-content: center;color: #0081c2;font-size: 25px;align-items: center;height: auto;display: flex;">
                                                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><h3 style="text-align: center;margin: 5px;font-size: 14px;font-family: ">Me Gusta(<?php echo $data->count ?>)</h3></div><br>
                                                                    </div>
                                                                </div>

                                                            </div>
                                                            <div class="col-xs-12  col-md-4 col-md-4 col-lg-4" style="padding-bottom: 20px;justify-content: center;display: flex;">
                                                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;color: #0081c2;font-size: 25px;align-items: center;">
                                                                    ...
                                                                    <div>
                                                                        <button class="btn btn-labeled btn-primary" data-toggle="modal" data-target="#ModalModificarMusica"><span class="btn-label"><i class="fa fa-save"></i></span> Modificar</button> 
                                                                        <button class="btn btn-labeled btn-success" ><span class="btn-label"><i class="glyphicon glyphicon-ok"></i></span> Activar </button> 
                                                                        <button class="btn btn-labeled btn-danger" ><span class="btn-label"><i class="glyphicon glyphicon-remove"></i></span>Desactivar </button> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id="tithim" class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display: flex;align-items: center;min-height: 60px;justify-content: center">
                                                        <div><strong  style="font-size:16px">No hay Musicas Encontradas</strong></div>
                                                    </div>
                                                <?php }
                                                ?>
                                            </div>
            ...
            <script src="../js/Musica/MusicaPersonal.js"></script>
